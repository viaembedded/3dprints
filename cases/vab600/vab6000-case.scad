...
wall_t=2.1;//thickness//actual most recent version has a base thickness of 2 but that is not yet fully implemented in this code
...
//	["N", "Cone",		[8,10,0,0,0,"inside"],					[4,5,4,8]		],
	...
	// LED
	["S", "Rectangle",	[-29.8,0.5,-4,0,0,"outside"],				[4,4.5,8.5,2,4]	],
	// USB -small slot
	["S", "Round_Rect",	[10.5,1.5,-4,-1.5,0,"outside"],				[4,68,8,2,4]	],
	// CPU cutout
	["B", "Rectangle",	[-10.2,5,0,0,0,"outside"],				[4,30.4,30.4,2,4]	],
...
//	["S", "Cylinder",	[-1,8,0,0,0,"inside"],					[6,3,10]		],//for comparison
	...
	// ["B", "Dip_Post",	[0,0,0,0,0,"outside"],					[6,3,1,1,6]		],
//	["N", "Cylinder",	[-1,8,0,0,0,"inside"],					[6,3,10]		],//for comparison
	...
	//["T", "Cylinder",	[11,-14.4,0,0,30,"inside"],					[5,3,6]		],
	//["T", "Cylinder",	[-11,-14.4,0,0,30,"inside"],				[5,3,6]		],//fail
	//["T", "Cylinder",	[-11,14.4,0,0,30,"inside"],					[5,3,6]		],
	//Posts near Network
	["B", "Dip_Post",	[-47.2,43,0,0,0,"inside"],				[2.05,3.1,1.25,1.7,26]		],
	["B", "Dip_Post",	[47.2,43,0,0,0,"inside"],				[2.05,3.1,1.25,1.7,26]		],
	//Posts near USB
	["B", "Dip_Post",	[-47.2,-23.3,0,0,0,"inside"],				[2.05,3.1,1.25,1.7,26]		],
	["B", "Dip_Post",	[47.2,-23.3,0,0,0,"inside"],				[2.05,3.1,1.25,1.7,26]		],
	...
	//["B", "Nub_Post",	[11,-14.4,0,0,30,"inside"],				[4.3,2.5,0.5,1.7,6]		],
	//["B", "Nub_Post",	[-22/2,28.8/2,0,0,30,"inside"],			[4.3,2.5,0.5,1.7,6]		]//for comparison//
	];
...
text = [//recessed text on faces [face_name, text_to_write, shape_position[x_pos,y_pos,x_offs,y_offs,rotate,align], shape_size[depth,font_height,font_spacing,mirror]] Note: for silly reasons mirror must be 0 or 1 corresponding to false and true in this version
	...
	// ["T", "THINK!",			[0,0,0,0,45,"outside"], 					[6,22,1,0]]
	...
	//["T", "VIA",	[0,0,0,0,90,"outside"], 					[1,6,1,0]]
	];
...
translate([-41,-96,2])  import("VAB.stl");